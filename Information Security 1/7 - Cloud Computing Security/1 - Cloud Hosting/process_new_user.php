...
// echo '<img src="'.$g->getURL("user", 'example.com', $secret).'" />';
...
$stmt = $mysqli->prepare("INSERT INTO users (id, username, password, secret) VALUES (null, ?, ?, ?)");
$stmt->bind_param("sss", $new_username, $hashed_password, $secret);
